...
/**
 * Copy that survives the dashboard iframe: the async Clipboard API is blocked
 * there without a `clipboard-write` permission, so fall back to a temporary
 * textarea + execCommand("copy") (allowed during the click gesture).
 */
